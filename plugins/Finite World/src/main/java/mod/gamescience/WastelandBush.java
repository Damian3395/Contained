...
/**
 * Dead bush blocks that are scattered throughout the wasteland.
 * Overrides Minecraft's default dead bush block, but adds the property
 * that it can also be planted on wasteland blocks.
 */
