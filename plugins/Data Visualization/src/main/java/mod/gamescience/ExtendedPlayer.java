...
/**
 * Extra data that should be stored and persisted regarding players
 */
public class ExtendedPlayer implements IExtendedEntityProperties {
	...
	public int[] getOccupationValues() {
		if (this.occupationValues == null) {
			this.occupationValues = new int[DataVisUtil.occupationNames.length];
			DataVisUtil.zero(this.occupationValues);
		}
