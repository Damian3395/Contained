...
public class EmblemBlockRender extends TileEntitySpecialRenderer {

	private ResourceLocation[] texture;
	
	public EmblemBlockRender() {
		texture = new ResourceLocation[5];
		for(int i=1; i<=4; i++)
			texture[i] = new ResourceLocation(Resources.MOD_ID, "textures/blocks/emblem_beam"+i+".png");
	}
	
    public void renderTileEntityAt(EmblemBlockTE te, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        float f1 = 1.0F;
        ...
        if (f1 > 0.0F && te.isActive)
        {
            ...
            this.bindTexture(texture[te.color]);
    ...
    {
        this.renderTileEntityAt((EmblemBlockTE)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}
